...
export const InvoiceDetailModal: React.FC<InvoiceDetailModalProps> = ({ invoice, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-xs overflow-y-auto animate-in fade-in duration-150 print:p-0 print:bg-white">
      <div className="bg-white w-full max-w-3xl rounded-3xl shadow-2xl border border-yellow-200 overflow-hidden my-8 print:shadow-none print:border-none print:m-0 print:w-full print:max-w-none">
        
        {/* Modal Action Bar (Hidden when printing) */}
        <div className="px-6 py-4 border-b border-yellow-200 flex items-center justify-between bg-yellow-50/80 print:hidden">
          <div className="flex items-center gap-2">
            <span className="px-3 py-1 rounded-full bg-emerald-100 text-emerald-800 text-xs font-black flex items-center gap-1 border border-emerald-200">
              ...
              <span>Factura Fiscal Emitida</span>
            </span>
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="inline-flex items-center gap-1.5 px-4 py-2 rounded-2xl bg-emerald-500 hover:bg-emerald-600 text-white text-xs font-black transition-all shadow-xs disabled:opacity-50"
            ...
            <button
              onClick={handlePrint}
              className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-2xl bg-orange-500 hover:bg-orange-600 text-white text-xs font-black transition-all shadow-xs"
            ...
            <button
              onClick={onClose}
              className="p-2 text-slate-400 hover:text-slate-600 rounded-2xl hover:bg-yellow-100"
            >
              <X className="w-5 h-5" />
            </button>
          </div>
        ...
        <div id="invoice-printable-area" className="p-8 sm:p-10 text-slate-800 space-y-8 bg-white">
